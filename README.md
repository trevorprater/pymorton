...
<div align="center"><bold>A lightweight Python library that enables ordinal hashing of multidimensonal data via <a href="https://en.wikipedia.org/wiki/Z-order_curve">Morton coding / Z-ordering</a>, along with support for geospatial indexing.</bold></div>
<p align="center">
